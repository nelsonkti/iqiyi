            ...
            if data:
                ...
                # 如果不是电影
                    ...
                    for series in item['series']:
                        ...
                        self.cursor.execute('SELECT * FROM video_series WHERE series_id = %s and video_id = %s',(series[0],video_id))
                        data1 = self.cursor.fetchone()
                        ...
                        if data1 is None:
                            ...
                            print("【更新剧集】。。。。")
                            self.cursor.execute("update video_series set url = %s, updated_at=%s where video_id=%s and series_id=%s",
